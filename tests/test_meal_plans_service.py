...
def service():
    with (
        patch("services.meal_plans_service.MealPlansRepository") as MockRepo,
...
def test_create_meal_plan_without_entries(service):
    data = {
        **{
            ...
            if k in ("nombre", "tipo", "fecha_inicio", "fecha_fin")
        },
        "entradas": [],
    }
...
def test_add_entry_fails_replaceable_not_covered(service):
    ...
    datos = {
        ...
        "tipo_comida": "almuerzo",
        "id_receta": "rec-1",
        "ingredientes_seleccionados": {"ing-1": "ing-3"},
    }  # ing-2 missing
    ...
    service.recipes_service.get_recipe_ingredients.return_value = [
        {
            ...
            "unidad": "g",
            "alternativas": [
                {"id_ingrediente": "ing-2", "cantidad": "400", "unidad": "g"}
            ],
        }
    ]
